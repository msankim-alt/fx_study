...
.block-container { padding:0 !important; max-width:100% !important; margin-top:56px !important; }
...
# ── 페이지 내용 래퍼 ──────────────────────────────────────────────────────────
st.markdown('<div style="max-width:1100px;margin:0 auto;padding:28px 24px;">', unsafe_allow_html=True)
...
<div style="padding:9px 0;border-bottom:1px solid #e2e8f0;
  ...
  <span style="font-size:10px;background:#dbeafe;color:#1d4ed8;
    padding:2px 6px;border-radius:4px;white-space:nowrap;margin-top:2px;">{source}</span>
